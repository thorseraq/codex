...
- Transient Telegram `getUpdates` transport failures, including mid-response disconnects, are retried with client recreation and backoff instead of stopping the bridge.
